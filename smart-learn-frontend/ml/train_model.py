    ...
    for digit in range(10):
        ...
        if count < MIN_SAMPLES_PER_CLASS:
            print(
                ...
                f'Run python ml/split_dataset.py to extract more samples.'
            )
            fatal = True
            continue
...
def main():
    ...
    parser.add_argument('--model-dir', type=Path, default=Path('ml/saved_model'),
    ...
    parser.add_argument('--dataset-dir', type=Path,
                        default=Path('ml/dataset_processed'),
                        help='Path to the processed custom dataset (default: ml/dataset_processed)')
    ...
    if args.dataset_dir.exists():
        ...
        print(
            ...
            f'   Run: python ml/split_dataset.py\n'
