...
const START_MARKER = { x: 430, y: 130 };
...
// Simple “5” trace path in viewBox 0 0 640 600, continuous for getPointAtLength.
    ...
    <main className='dg-shell dg-theme-ta dc-number-page dc-cartoon-bg'>
      ...
      <section className='dg-stage dc-trace-stage'>
        <header className='dg-header dc-instruction-box'>
          <h1 onClick={handleAudio}>‘5’ {AUDIO_TEXT} අංකය ලියමු</h1>
        </header>
