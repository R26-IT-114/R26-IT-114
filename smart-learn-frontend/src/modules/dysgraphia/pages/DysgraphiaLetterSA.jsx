...
// ──────────────────────────────────────────────────────
const SA_STAR_COLORS = ['#ffffff','#ffe4b5','#add8e6','#ffcccb','#b0e0e6','#fff176','#e0b0ff'];
const SaStarField = () => {
  const stars = Array.from({ length: 160 }, (_, i) => ({
    ...
    color: SA_STAR_COLORS[Math.floor(Math.random() * SA_STAR_COLORS.length)],
  }));
  return (
