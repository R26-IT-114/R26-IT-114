...
const SA_GUIDE_PATH =
  'M 250 130 C 190 200 180 315 240 405 C 300 495 430 515 515 450 C 575 405 580 295 520 235 C 465 185 370 190 315 255 C 270 310 275 385 350 425';

const START_MARKER = { x: 250, y: 130 };
const END_MARKER = { x: 350, y: 425 };
