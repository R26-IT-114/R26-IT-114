...
const DysgraphiaLetterYA = () => {
  ...
  const submitCanvasForEvaluation = async () => {
    ...
    try {
      ...
      const res     = await fetch(EVAL_ENDPOINT, { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ image: dataUrl, letter: 'ya' }) });
            ...
            >
              ...
              {!blindMode && (
                <>
                  ...
                  {thirdPreviewVisible && (
                    <path d={YA_GUIDE_PATH} fill='none' stroke='rgba(255,255,255,0.95)' strokeWidth='40'
