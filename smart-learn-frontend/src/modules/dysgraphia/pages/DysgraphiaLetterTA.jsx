...
/* ─────────────────────────────────────────────────────────
   Star burst data (static — no Math.random on each render)
───────────────────────────────────────────────────────── */
const BURST_STARS = [
  { x: '-240px', y: '-210px', delay: '0s',    size: '2.8rem', emoji: '⭐' },
  { x:    '0px', y: '-270px', delay: '0.07s', size: '2.2rem', emoji: '🌟' },
  { x:  '240px', y: '-210px', delay: '0.14s', size: '2.8rem', emoji: '⭐' },
  { x:  '280px', y:    '0px', delay: '0.09s', size: '2rem',   emoji: '✨' },
  { x:  '240px', y:  '210px', delay: '0.18s', size: '2.5rem', emoji: '⭐' },
  { x:    '0px', y:  '270px', delay: '0.04s', size: '2rem',   emoji: '🌟' },
  { x: '-240px', y:  '210px', delay: '0.12s', size: '2.5rem', emoji: '⭐' },
  { x: '-280px', y:    '0px', delay: '0.19s', size: '2rem',   emoji: '✨' },
...
/* ── Correct-drawing full-screen star celebration ─────── */
