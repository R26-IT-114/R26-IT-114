    ...
    <main className='dg-shell dg-theme-a'>
      ...
      <section className='dg-stage'>
        <header className='dg-header'>
           <img src={Topic} alt="ම අක්ෂරය" className="dg-topic-image"onClick={handleAudio}/>
        </header>
        ...
        <div className={`dg-canvas-wrap${drawingWithCanvas ? ' no-board' : ''}`}>
          {!drawingWithCanvas ? (
            ...
            <div className='dg-practice-wrap' style={{ width: '100%', height: '100%' }}>
              ...
              <div className='dg-practice-canvas-shell' style={{ position: 'relative', margin: '16px auto', borderRadius: '60px', overflow: 'hidden' }}>
