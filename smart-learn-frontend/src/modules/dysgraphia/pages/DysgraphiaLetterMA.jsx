...
const MA_GUIDE_PATH =
  'M 230 110 C 170 190 170 320 230 420 C 290 520 430 530 520 455 C 585 400 575 280 510 225 C 455 180 365 190 320 245 C 285 290 285 355 340 395 C 390 430 455 425 500 390';

const START_MARKER = { x: 230, y: 110 };
...
const DysgraphiaLetterMA = () => {
  ...
  const handleAudio = () => {
    ...
    const utterance = new SpeechSynthesisUtterance('ම');
