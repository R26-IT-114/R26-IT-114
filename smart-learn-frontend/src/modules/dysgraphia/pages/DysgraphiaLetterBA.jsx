              ...
              {!blindMode && (
                <>
                  {!practiceBlind && !thirdPreviewVisible && (
                    <path d={BA_GUIDE_PATH} className='dg-chain-path' style={{ stroke: '#ffffff', strokeOpacity: 0.9, filter: 'drop-shadow(0 0 8px #ffffff)' }} />
                  )}
                  ...
                  {thirdPreviewVisible && (
                    <path d={BA_GUIDE_PATH} fill='none' stroke='#ffffff' strokeWidth='40'
